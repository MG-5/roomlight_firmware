...
public:
    ...
    static constexpr PwmOutput16Bit RedChannel{&htim3, TIM_CHANNEL_2};
    static constexpr PwmOutput16Bit GreenChannel{&htim3, TIM_CHANNEL_1};
    static constexpr PwmOutput16Bit BlueChannel{&htim2, TIM_CHANNEL_1};
    TripleLed<uint16_t> switchLed{RedChannel, GreenChannel, BlueChannel};
