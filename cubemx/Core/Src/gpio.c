...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LED_RED_Pin|LED_GREEN1_Pin|LED_GREEN2_Pin|LED_GREEN3_Pin 
                          |ESP_GPIO2_Pin|ESP_GPIO0_Pin|ESP_RST_Pin|ESP_EN_Pin 
                          |SW_BLUE_Pin|SW_GREEN_Pin|SW_RED_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = LED_RED_Pin|LED_GREEN1_Pin|LED_GREEN2_Pin|LED_GREEN3_Pin 
                          |ESP_GPIO2_Pin|ESP_GPIO0_Pin|ESP_RST_Pin|ESP_EN_Pin 
                          |SW_BLUE_Pin|SW_GREEN_Pin|SW_RED_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
